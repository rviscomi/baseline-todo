...
One interesting angle to this data is to potenitally look at how quickly sites fully adopt features after they become Baseline-ready, and if sites using AI-assisted migration PRs are quiker to adopt them.
